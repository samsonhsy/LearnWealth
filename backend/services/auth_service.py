...
def authenticate_user(email: str, pwd: str, db: Session) -> User | None:
...
def get_current_admin_user(db: Session = Depends(get_db), user: User = Depends(get_current_user)) -> User:
